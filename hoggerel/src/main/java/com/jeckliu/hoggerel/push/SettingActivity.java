...
import com.jeckliu.push.ExampleUtil;
...
public class SettingActivity extends InstrumentedActivity implements OnClickListener {
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(com.jeckliu.push.R.layout.set_push_time);
		init();
		initListener();
	}
   ...
   @Override
	...
	private void init(){
		startTime = (TimePicker) findViewById(com.jeckliu.push.R.id.start_time);
		endTime = (TimePicker) findViewById(com.jeckliu.push.R.id.end_time);
		startTime.setIs24HourView(DateFormat.is24HourFormat(this));
		endTime.setIs24HourView(DateFormat.is24HourFormat(this));
		mSetTime = (Button)findViewById(com.jeckliu.push.R.id.bu_setTime);
		mMonday = (CheckBox)findViewById(com.jeckliu.push.R.id.cb_monday);
		mTuesday = (CheckBox)findViewById(com.jeckliu.push.R.id.cb_tuesday);
		mWednesday = (CheckBox)findViewById(com.jeckliu.push.R.id.cb_wednesday);
	    mThursday = (CheckBox)findViewById(com.jeckliu.push.R.id.cb_thursday);
		mFriday = (CheckBox)findViewById(com.jeckliu.push.R.id.cb_friday);
		mSaturday = (CheckBox)findViewById(com.jeckliu.push.R.id.cb_saturday);
		mSunday = (CheckBox)findViewById(com.jeckliu.push.R.id.cb_sunday);
	}
	...
	public void onClick(View v) {
		int i = v.getId();
		if (i == com.jeckliu.push.R.id.bu_setTime) {
			v.requestFocus();
	...
	private void setPushTime(){
		...
		mEditor.commit();
		Toast.makeText(SettingActivity.this, com.jeckliu.push.R.string.setting_su, Toast.LENGTH_SHORT).show();
	}
