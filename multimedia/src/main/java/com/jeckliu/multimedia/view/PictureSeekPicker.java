...
public class PictureSeekPicker extends View{
    ...
    public PictureSeekPicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for(int i =  0; i < count; i++){
            ...
            if (value == R.styleable.PictureSeekPicker_lineColor) {
                lineColor = a.getColor(value, Color.WHITE);

            } else if (value == R.styleable.PictureSeekPicker_thumbColor) {
                thumbColor = a.getColor(value, Color.WHITE);

            } else if (value == R.styleable.PictureSeekPicker_thumbWidth) {
                thumbWidth = a.getDimension(value, 10);

            } else if (value == R.styleable.PictureSeekPicker_thumbHeight) {
                thumbHeight = a.getDimension(value, 50);

            } else if (value == R.styleable.PictureSeekPicker_thumbTotalProgress) {
                thumbTotalProgress = a.getInt(value, 10);

            } else if (value == R.styleable.PictureSeekPicker_thumbLeftProgress) {
                thumbLeftProgress = a.getInt(value, 0);

            } else if (value == R.styleable.PictureSeekPicker_thumbRightProgress) {
