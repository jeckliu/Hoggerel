...
public class BothwaySeekBar extends View{
    ...
    public BothwaySeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for(int i =  0; i < count; i++){
            ...
            if (value == R.styleable.BothwaySeekBar_barBg) {
                barBg = a.getColor(value, Color.GRAY);

            } else if (value == R.styleable.BothwaySeekBar_progressBg) {
                progressBg = a.getColor(value, Color.RED);

            } else if (value == R.styleable.BothwaySeekBar_thumbLeftColor) {
                thumbLeftColor = a.getColor(value, Color.BLUE);

            } else if (value == R.styleable.BothwaySeekBar_thumbRightColor) {
                thumbRightColor = a.getColor(value, Color.BLUE);

            } else if (value == R.styleable.BothwaySeekBar_barHeight) {
                barPaintWidth = a.getDimension(value, 10);

            } else if (value == R.styleable.BothwaySeekBar_thumbRadius) {
                thumbRadius = a.getDimension(value, 5);

            } else if (value == R.styleable.BothwaySeekBar_seekLeftProgress) {
                seekLeftProgress = a.getInt(value, 0);

            } else if (value == R.styleable.BothwaySeekBar_seekRightProgress) {
                seekRightProgress = a.getInt(value, 100);

            } else if (value == R.styleable.BothwaySeekBar_seekTotalProgress) {
